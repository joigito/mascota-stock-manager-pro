...
import { Shield, Building2, User, Crown, Trash2 } from 'lucide-react';
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Select value={selectedGlobalRole} onValueChange={setSelectedGlobalRole}>
                ...
                <Button 
                  ...
                  disabled={!selectedGlobalRole || loading}
                >
                  Asignar
                </Button>
              </div>
