-- Clean up all existing RLS policies and recreate them correctly
...
DROP POLICY IF EXISTS "Organization members can insert products" ON products;
...
-- Drop ALL existing policies for sales
...
DROP POLICY IF EXISTS "Organization members can view sales" ON sales;
DROP POLICY IF EXISTS "Organization members can create sales" ON sales;
DROP POLICY IF EXISTS "Organization members can update sales" ON sales;
DROP POLICY IF EXISTS "Organization members can delete sales" ON sales;
...
DROP POLICY IF EXISTS "Organization members can view customers" ON customers;
DROP POLICY IF EXISTS "Organization members can create customers" ON customers;
DROP POLICY IF EXISTS "Organization members can update customers" ON customers;
DROP POLICY IF EXISTS "Organization members can delete customers" ON customers;
...
-- Recreate clean policies for SALES
...
-- Recreate clean policies for CUSTOMERS
